...
export default function ThemeGallery() {
  ...
  const handleApplyTheme = () => {
    if (previewTheme) {
      setIsApplying(true);
      const theme = dashboardThemes.find(t => t.id === previewTheme);
      if (theme) {
        setDashboardTheme(previewTheme);
        toast({
          title: 'Theme Applied',
  ...
  const activeTheme = previewTheme || dashboardTheme.id;
    ...
    <AppShell>
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          ...
          {previewTheme && previewTheme !== dashboardTheme.id && (
