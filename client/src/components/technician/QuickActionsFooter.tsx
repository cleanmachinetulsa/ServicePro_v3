...
export function QuickActionsFooter({
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 h-[60px] bg-blue-950/95 backdrop-blur-lg border-t border-blue-800 z-50">
      <div className="h-full px-2 md:px-4 flex items-center justify-center gap-2 md:gap-3">
        <Button
          size="lg"
          onClick={onMarkOnSite}
          disabled={disabled}
          className="flex-1 max-w-[200px] h-12 bg-purple-600 hover:bg-purple-700 text-white font-semibold"
        ...
        <Button
          ...
          className="flex-1 max-w-[200px] h-12 bg-red-600 hover:bg-red-700 text-white font-semibold"
        ...
        <Button
          ...
          disabled={disabled}
          className="flex-1 max-w-[200px] h-12 bg-green-600 hover:bg-green-700 text-white font-semibold"
        ...
        <Button
          ...
          onClick={onNextJob}
          disabled={disabled}
          className="flex-1 max-w-[200px] h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold"
