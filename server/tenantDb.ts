...
import { 
  ...
  authorizations, paymentLinks, giftCards, giftCardRedemptions, creditLedger,
...
const TABLE_METADATA = new Map<any, { tenantIdColumn: any }>([
  ...
  [giftCardRedemptions, { tenantIdColumn: giftCardRedemptions.tenantId }],
  ...
  [customerThreads, { tenantIdColumn: customerThreads.tenantId }],
]);
